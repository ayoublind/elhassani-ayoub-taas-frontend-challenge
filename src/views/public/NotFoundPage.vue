<template>
    <div
        class="w-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
        ...
        <div class="w-1/2 flex lg:items-end justify-center p-4">
            <img src="https://cdni.iconscout.com/illustration/premium/thumb/not-found-4064375-3363936.png"
                alt="404 Not Found">
        </div>
    </div>
</template>
